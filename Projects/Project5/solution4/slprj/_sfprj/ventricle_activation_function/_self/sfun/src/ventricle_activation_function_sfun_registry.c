...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_ventricle_activation_function_process_check_sum_call
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_ventricle_activation_function_process_check_sum_call(nlhs,plhs,nrhs,
       prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_ventricle_activation_function_autoinheritance_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_ventricle_activation_function_autoinheritance_info(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_ventricle_activation_function_get_eml_resolved_functions_info( int nlhs,
  ...
  if (strcmp(machineName, "ventricle_activation_function") == 0) {
    const mxArray *newRhs[2] = { NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_ventricle_activation_function_get_eml_resolved_functions_info(nlhs,
      plhs,2,newRhs);
  }
...
extern unsigned int sf_ventricle_activation_function_method_dispatcher(SimStruct
  *S, unsigned int chartFileNumber, int_T method, void *data);
...
{
  if (!strcmp(machineName,"ventricle_activation_function")) {
    return(sf_ventricle_activation_function_method_dispatcher(simstructPtr,
...
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    ventricle_activation_function_terminator();
    sf_debug_terminate();
  }
...
extern void ventricle_activation_function_register_exported_symbols(SimStruct* S);
extern void ventricle_activation_function_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  ventricle_activation_function_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      ventricle_activation_function_debug_initialize();
    }

    ventricle_activation_function_initializer();
  }
