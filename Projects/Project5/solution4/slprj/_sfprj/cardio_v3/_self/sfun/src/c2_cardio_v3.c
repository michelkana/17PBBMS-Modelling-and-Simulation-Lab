...
static void c2_update_debugger_state_c2_cardio_v3(void);
static const mxArray *get_sim_state_c2_cardio_v3(void);
static void set_sim_state_c2_cardio_v3(const mxArray *c2_st);
...
static const mxArray *get_sim_state_c2_cardio_v3(void)
{
  ...
  c2_b_u = chartInstance.c2_is_active_c2_cardio_v3;
  c2_c_y = NULL;
...
static void set_sim_state_c2_cardio_v3(const mxArray *c2_st)
{
  ...
  real_T c2_d0;
  real_T c2_b_y;
  const mxArray *c2_b_is_active_c2_cardio_v3;
  uint8_T c2_u0;
  uint8_T c2_c_y;
  real_T *c2_d_y;
  c2_d_y = (real_T *)ssGetOutputPortSignal(chartInstance.S, 1);
  ...
  sf_mex_destroy(&c2_y);
  *c2_d_y = c2_b_y;
  c2_b_is_active_c2_cardio_v3 = sf_mex_dup(sf_mex_getcell(c2_u, 1));
  sf_mex_import("is_active_c2_cardio_v3", sf_mex_dup(c2_b_is_active_c2_cardio_v3),
                &c2_u0, 1, 3, 0U, 0, 0U, 0);
  c2_c_y = c2_u0;
  sf_mex_destroy(&c2_b_is_active_c2_cardio_v3);
  chartInstance.c2_is_active_c2_cardio_v3 = c2_c_y;
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_cardio_v3();
...
static mxArray *sf_get_sim_state_info_c2_cardio_v3(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c2_cardio_v3\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_cardio_v3_get_check_sum(&mxChecksum);
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_cardio_v3MachineNumber_,
            chartInstance.chartNumber);
          sf_debug_set_chart_disable_implicit_casting(_cardio_v3MachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(_cardio_v3MachineNumber_,
        chartInstance.chartNumber,chartInstance.instanceNumber);
    }
  }
}
...
static mxArray* sf_opaque_get_sim_state_c2_cardio_v3(void *chartInstanceVar)
{
  mxArray *st = (mxArray *) get_sim_state_c2_cardio_v3();
  return st;
}

static void sf_opaque_set_sim_state_c2_cardio_v3(void *chartInstanceVar, const
  mxArray *st)
{
  set_sim_state_c2_cardio_v3(sf_mex_dup(st));
}
...
static void mdlSetWorkWidths_c2_cardio_v3(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("cardio_v3","cardio_v3",2);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("cardio_v3","cardio_v3",2,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("cardio_v3","cardio_v3",2,
      "gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"cardio_v3","cardio_v3",2,2);
      sf_mark_chart_reusable_outputs(S,"cardio_v3","cardio_v3",2,1);
    }

    sf_set_rtw_dwork_info(S,"cardio_v3","cardio_v3",2);
...
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "cardio_v3", "cardio_v3",2);
...
static void mdlStart_c2_cardio_v3(SimStruct *S)
{
  ...
  chartInstance.chartInfo.getSimState = sf_opaque_get_sim_state_c2_cardio_v3;
  chartInstance.chartInfo.setSimState = sf_opaque_set_sim_state_c2_cardio_v3;
  chartInstance.chartInfo.getSimStateInfo = sf_get_sim_state_info_c2_cardio_v3;
