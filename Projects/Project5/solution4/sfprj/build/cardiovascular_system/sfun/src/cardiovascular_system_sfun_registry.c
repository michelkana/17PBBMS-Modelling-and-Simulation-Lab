...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
 const mxArray * prhs[] )
{
  extern unsigned int sf_cardiovascular_system_process_check_sum_call( int nlhs,
   mxArray * plhs[], int nrhs, const mxArray * prhs[] );

  if(sf_cardiovascular_system_process_check_sum_call(nlhs,plhs,nrhs,prhs))
  return 1;
  return 0;
}
...
{
  extern unsigned int sf_cardiovascular_system_autoinheritance_info( int nlhs,
   mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if(sf_cardiovascular_system_autoinheritance_info(nlhs,plhs,nrhs,prhs)) return
  1;
  return 0;
}
...
{
  extern unsigned int sf_cardiovascular_system_get_eml_resolved_functions_info(
   int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if(sf_cardiovascular_system_get_eml_resolved_functions_info(nlhs,plhs,nrhs,prhs))
  return 1;
  return 0;
}
...
extern unsigned int sf_cardiovascular_system_method_dispatcher(SimStruct *S,
...
{
  if(!strcmp(machineName,"cardiovascular_system")) {
    return(sf_cardiovascular_system_method_dispatcher(simstructPtr,chartFileNumber,method,data));
  }
  return 0;
}
extern void cardiovascular_system_terminator(void);
void sf_machine_global_terminator(void)
{
  if(sfMachineGlobalTerminatorCallable) {
    ...
    cardiovascular_system_terminator();
    sf_debug_terminate();
  }
  return;
}
extern void cardiovascular_system_initializer(void);
extern void cardiovascular_system_register_exported_symbols(SimStruct* S);
extern void cardiovascular_system_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  cardiovascular_system_register_exported_symbols(S);
}
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if(sfMachineGlobalInitializerCallable) {
    ...
    if(!simModeIsRTWGen) {
      cardiovascular_system_debug_initialize();
    }
    cardiovascular_system_initializer();
  }
  return;
}
