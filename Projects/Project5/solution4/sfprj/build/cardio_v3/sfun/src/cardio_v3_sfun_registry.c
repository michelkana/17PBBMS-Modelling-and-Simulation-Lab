 ...
 const mxArray * prhs[] )
{
  ...
  if(sf_cardio_v3_process_check_sum_call(nlhs,plhs,nrhs,prhs)) return 1;
  return 0;
}
 ...
 nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_cardio_v3_autoinheritance_info( int nlhs, mxArray *
   plhs[], int nrhs, const mxArray * prhs[] );
  if(sf_cardio_v3_autoinheritance_info(nlhs,plhs,nrhs,prhs)) return 1;
  return 0;
}
 ...
 * plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if(sf_cardio_v3_get_eml_resolved_functions_info(nlhs,plhs,nrhs,prhs)) return 1;
  return 0;
}
 ...
 char *machineName, unsigned int chartFileNumber, int_T method, void *data)
{
  if(!strcmp(machineName,"cardio_v3")) {
    return(sf_cardio_v3_method_dispatcher(simstructPtr,chartFileNumber,method,data));
  }
  return 0;
}
