...
#define _SFD_SET_DATA_VALUE_PTR(v1,v2)\
	sf_debug_set_instance_data_value_ptr(_cardio_v3MachineNumber_,CHARTINSTANCE_CHARTNUMBER,CHARTINSTANCE_INSTANCENUMBER,v1,(void *)(v2));
...
#define _SFD_EML_CALL(v1,v2,v3) sf_debug_call(_cardio_v3MachineNumber_,\
CHARTINSTANCE_CHARTNUMBER,\
CHARTINSTANCE_INSTANCENUMBER,\
