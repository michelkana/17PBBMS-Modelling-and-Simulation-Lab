...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
 const mxArray * prhs[] )
{
  extern unsigned int sf_cardiovascular_control_process_check_sum_call( int
   nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );

  if(sf_cardiovascular_control_process_check_sum_call(nlhs,plhs,nrhs,prhs))
  return 1;
  return 0;
}
...
{
  extern unsigned int sf_cardiovascular_control_autoinheritance_info( int nlhs,
   mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if(sf_cardiovascular_control_autoinheritance_info(nlhs,plhs,nrhs,prhs)) return
  1;
  return 0;
}
...
{
  extern unsigned int sf_cardiovascular_control_get_eml_resolved_functions_info(
   int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if(sf_cardiovascular_control_get_eml_resolved_functions_info(nlhs,plhs,nrhs,prhs))
  return 1;
  return 0;
}
...
extern unsigned int sf_cardiovascular_control_method_dispatcher(SimStruct *S,
...
{
  if(!strcmp(machineName,"cardiovascular_control")) {
    return(sf_cardiovascular_control_method_dispatcher(simstructPtr,chartFileNumber,method,data));
  }
  return 0;
}
extern void cardiovascular_control_terminator(void);
void sf_machine_global_terminator(void)
{
  if(sfMachineGlobalTerminatorCallable) {
    ...
    cardiovascular_control_terminator();
    sf_debug_terminate();
  }
  return;
}
extern void cardiovascular_control_initializer(void);
extern void cardiovascular_control_register_exported_symbols(SimStruct* S);
extern void cardiovascular_control_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  cardiovascular_control_register_exported_symbols(S);
}
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if(sfMachineGlobalInitializerCallable) {
    ...
    if(!simModeIsRTWGen) {
      cardiovascular_control_debug_initialize();
    }
    cardiovascular_control_initializer();
  }
  return;
}
